...
namespace DirectX
{
    namespace SimpleMath
    {
        ...
        struct Rectangle
        {
            ...
            Rectangle& operator=(_In_ const XMFLOAT4& f) noexcept { x = (long)f.x; y = (long)f.y; width = (long)f.z; height = (long)f.w; return *this; }
        ...
        struct Vector2 : public XMFLOAT2
        {
            ...
            operator XMFLOAT3() const noexcept { return XMFLOAT3(x, y, 0.f); }
            operator XMFLOAT4() const noexcept { return XMFLOAT4(x, y, 0.f, 0.f); }
            ...
            Vector2& operator= (const XMFLOAT3& F) noexcept { x = F.x; y = F.y; return *this; }
            Vector2& operator= (const XMFLOAT4& F) noexcept { x = F.x; y = F.y; return *this; }
        ...
        struct Vector3 : public XMFLOAT3
        {
            ...
            operator XMFLOAT2() const noexcept { return XMFLOAT2(x, y); }
            operator XMFLOAT4() const noexcept { return XMFLOAT4(x, y, 0.f, 0.f); }
            ...
            Vector3& operator= (const XMFLOAT2& F) noexcept { x = F.x; y = F.y; return *this; }
            Vector3& operator= (const XMFLOAT4& F) noexcept { x = F.x; y = F.y;  z = F.z; return *this; }            Vector3& operator+= (const Vector3& V) noexcept;
        ...
        struct Vector4 : public XMFLOAT4
        {
            ...
            Vector4& operator= (const XMFLOAT2& F) noexcept { x = F.x; y = F.y; return *this; }
            Vector4& operator= (const XMFLOAT3& F) noexcept { x = F.x; y = F.y;  z = F.z; return *this; }            Vector3& operator+= (const Vector3& V) noexcept;
